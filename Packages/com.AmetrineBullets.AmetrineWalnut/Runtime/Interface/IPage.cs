...
namespace com.AmetrineBullets.AmetrineWalnut.Interface
{
    public interface IPage
    {
        ...
        public virtual async UniTask OnBeforeTransition()
        {
            await UniTask.RunOnThreadPool(() => { });
            // Save the current state to PageState
        }
        ...
        public virtual async UniTask OnTransitionOut(UniTaskCompletionSource loadPageCompletionSource)
        {
            await UniTask.RunOnThreadPool(() => { });
            // Save the current state to PageState
        }

        public virtual async UniTask OnEndTransition()
        {
            await UniTask.RunOnThreadPool(() => { });
            // Save the current state to PageState
        }

        public virtual async UniTask OnBeforePagePush()
        {
            await UniTask.RunOnThreadPool(() => { });
            // Save the current state to PageState
        }

        public virtual async UniTask OnPagePush()
        {
            await UniTask.RunOnThreadPool(() => { });
            // Save the current state to PageState
        }

        public virtual async UniTask OnEndPagePush()
        {
            await UniTask.RunOnThreadPool(() => { });
            // Save the current state to PageState
        }

        public virtual async UniTask OnNextPagePush()
        {
            await UniTask.RunOnThreadPool(() => { });
            // Save the current state to PageState
        }

        public virtual async UniTask OnBeforePagePop()
        {
            await UniTask.RunOnThreadPool(() => { });
            // Save the current state to PageState
        }

        public virtual async UniTask OnPagePop()
        {
            await UniTask.RunOnThreadPool(() => { });
            // Save the current state to PageState
        }

        public virtual async UniTask OnEndPagePop()
        {
            await UniTask.RunOnThreadPool(() => { });
            // Save the current state to PageState
        }

        public virtual async UniTask OnUnskippedPagePop()
        {
            await UniTask.RunOnThreadPool(() => { });
            // Save the current state to PageState
        }

        public virtual async UniTask OnNextPagePop()
        {
            await UniTask.RunOnThreadPool(() => { });
            // Save the current state to PageState
        }
